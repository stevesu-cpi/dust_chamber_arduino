/*
date: 12/9/2022 
fname: Dust_Chamber_V2_Code_Su_01.ino
Description: code modified by Steve Su to increase dust expelled by creating "stage 2" (starts at end of 4hours) which increased the time of air ejected and decreased the dwell time between each firing.
notes: The regulator press was set at 60 psi for entire 8hr 
*/
...
const int TIME_ON = 3; // On time in seconds per RELAY for stage 1
const int TIME_OFF = 300; // Off time in seconds AFTER all RELAYS ON cycles for stage 1
